      ...
      <div className="flex flex-col gap-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <header className="flex flex-col xl:flex-row xl:items-end justify-between gap-10 py-6">
          <div className="space-y-5">
            ...
            <h1 className="text-6xl md:text-8xl font-black font-headline tracking-tighter text-slate-900 leading-[0.85] text-balance">
          ...
          <div className="flex flex-wrap gap-5 shrink-0">
            <Button variant="outline" className="rounded-3xl h-16 px-10 border-slate-200 font-black text-slate-600 hover:bg-white hover:border-primary transition-all text-lg shadow-sm" asChild>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              {(profile?.role === 'administration' || isSuperAdmin) && (
                <Card className="border-none bg-slate-900 text-white shadow-3xl relative overflow-hidden group rounded-[3rem] p-4 transition-all hover:scale-[1.01]">
              ...
              {/* News Snippet */}
              <Card className="shadow-2xl shadow-slate-200/60 border-none bg-white group hover:translate-y-[-8px] transition-all duration-500 rounded-[3rem] overflow-hidden p-2">
                <CardHeader className="p-10 pb-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-4 bg-primary/10 rounded-2xl text-primary shadow-lg shadow-primary/5">
                      <Megaphone size={32} />
                    </div>
                    <Badge className="bg-slate-100 text-slate-500 font-black text-[10px] uppercase tracking-[0.2em] border-none px-4 py-1.5 rounded-full">Active Feed</Badge>
                  </div>
                  <CardTitle className="text-3xl font-black text-slate-900 leading-none">{t.recentBulletin}</CardTitle>
                </CardHeader>
                <CardContent className="px-10 pb-10">
                  <div className="p-8 rounded-[2rem] bg-slate-50 border border-slate-100 mb-10 group-hover:bg-white group-hover:border-primary/20 group-hover:shadow-xl transition-all duration-500">
                    <h4 className="font-black text-slate-900 text-xl mb-3">Campus Infrastructure Update</h4>
                    <p className="text-lg text-slate-500 font-medium leading-relaxed line-clamp-3">Major renovations planned for the main auditorium and laboratory wing are set to begin next semester. Stay tuned for...</p>
                  </div>
            ...
            {profile?.role === 'council' && (
              <div className="p-12 rounded-[3.5rem] bg-orange-50 border border-orange-100/60 flex flex-col md:flex-row items-center gap-10 shadow-3xl shadow-orange-500/10 group transition-all hover:bg-orange-100/30">
                <div className="p-8 bg-white rounded-[2.5rem] text-orange-600 shadow-2xl shadow-orange-500/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                  <ShieldAlert size={56} />
                </div>
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-3xl font-black text-orange-950 mb-2 leading-none">{t.actionRequired}</h3>
                  <p className="text-orange-800/60 font-bold text-xl">{t.proposalsReview}</p>
                </div>
          ...
          <div className="lg:col-span-4">
            <Card className="shadow-2xl shadow-slate-200/60 border-none bg-white rounded-[3rem] h-full overflow-hidden flex flex-col p-2">
              <CardHeader className="p-10 pb-4">
                <div className="flex items-center justify-between mb-8">
                  <div className="space-y-2">
                    <CardTitle className="text-3xl font-black text-slate-900 leading-none">{t.nextMeeting}</CardTitle>
                ...
                <div className="flex items-center gap-6 p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 group hover:bg-white hover:shadow-xl hover:border-accent/20 transition-all duration-500">
                  <div className="flex flex-col items-center justify-center min-w-[90px] h-[90px] bg-white rounded-3xl shadow-xl shadow-black/5 border border-slate-100 group-hover:bg-accent group-hover:text-white transition-all">
                  ...
                  <div className="min-w-0">
                    <h4 className="font-black text-slate-900 text-2xl leading-tight truncate mb-1">Thursday General</h4>
                    <p className="text-base text-slate-500 font-bold">Room 402 • 14:30</p>
                  </div>
                </div>
              </CardHeader>
              
              <CardContent className="px-10 pb-10 flex-1 flex flex-col">
                <Separator className="bg-slate-100 my-10" />
                  ...
                  <div className="space-y-6">
                    {['Budget Allocation Q4', 'Annual Sports Week Prep', 'Cafeteria Menu Update'].map((item, i) => (
                      <div key={i} className="flex items-center gap-5 group cursor-pointer">
                        ...
                        <span className="text-lg text-slate-700 font-bold group-hover:text-primary group-hover:translate-x-1 transition-all">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
                <div className="mt-auto pt-12">
                  <Button variant="outline" className="w-full h-16 font-black border-slate-200 rounded-3xl hover:bg-slate-50 hover:border-primary transition-all text-lg shadow-sm">
                    {t.addCalendar}
                  </Button>
                </div>
              </CardContent>
