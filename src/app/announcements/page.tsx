...
export default function AnnouncementsPage() {
  ...
  return (
    <AppLayout>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[650px] max-h-[90vh] overflow-y-auto no-scrollbar rounded-2xl p-8 bg-white dark:bg-slate-950 border-none shadow-2xl">
              ...
              <DialogFooter className="gap-3">
                ...
                <Button className="font-black h-12 rounded-xl px-10 shadow-lg shadow-primary/10 text-sm text-white" onClick={createAnnouncement}>{t.publish}</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        )}
      ...
      <div className="grid grid-cols-1 gap-10 w-full pb-32 max-w-5xl mx-auto">
        {fetching ? (
          ...
          <div className="col-span-full text-center py-32 bg-white dark:bg-slate-900/50 rounded-2xl border-2 border-dashed border-slate-100 dark:border-slate-800/50 flex flex-col items-center gap-8 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 dark:text-slate-500 font-bold text-lg max-w-md mx-auto leading-relaxed">The board is clear. Check back later for official MBN updates.</p>
            </div>
          </div>
        ) : (
              ...
              <div className="p-10 flex flex-col md:flex-row gap-10">
                <div className="md:w-1/3 flex flex-col justify-between">
                  ...
                  <div className="mt-10 flex items-center gap-4 border-t dark:border-slate-800/50 pt-8">
                    <Avatar className="h-12 w-12 border-4 border-slate-50 dark:border-slate-800 shadow-lg">
                      <AvatarFallback className="bg-primary text-white font-black text-lg">
                        {ann.authorRole?.charAt(0) || 'M'}
                      </AvatarFallback>
                    </Avatar>
                    <div className="flex flex-col">
                      <span className="text-sm font-black text-slate-900 dark:text-white leading-none mb-1">MBN Hub</span>
