    ...
    <AppLayout>
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 animate-in fade-in slide-in-from-top-4 duration-1000 w-full px-4">
        <div className="space-y-2">
          <Badge className="bg-primary/10 text-primary font-black mb-1 rounded-full px-4 py-1 border-none shadow-sm uppercase tracking-[0.2em] text-[8px]">Archives</Badge>
          ...
          <p className="text-slate-500 dark:text-slate-400 font-bold text-lg tracking-tight">Consultation de la Délégation Active</p>
        </div>
      </header>
